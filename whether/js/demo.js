var DEMO = {
    ...
    InitializeLoader: function InitializeLoader() {
        ...
        this.imageLoader = new THREE.ImageLoader(this.Loader);
    },
    ...
    InitializeScene: function InitializeScene() {
        ...
        this.imageLoader.load('img/water-drop.png', function(image) {
    ...
    LoadMountains: function LoadSkyBox() {
        ...
        this.imageLoader.load('img/mountains.png', function(image) {
